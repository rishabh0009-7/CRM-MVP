        ...
        <div className="px-6">
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            >
              <Card className="bg-white border-0 shadow-lg rounded-2xl">
                <CardHeader className="pb-4">
                  <CardTitle className="text-xl font-bold text-gray-900">How Revenue Works</CardTitle>
                  <CardDescription className="text-gray-600">
                    Understanding your CRM revenue system
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="p-4 rounded-lg bg-green-50 border border-green-200">
                      ...
                      <p className="text-sm text-green-600">
                        Revenue increases when proposals are marked as "accepted". Create proposals for your clients and update their status to see revenue growth.
                      </p>
                    </div>
                    <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                      ...
                      <p className="text-sm text-blue-600">
                        Add new clients to increase your customer base. Active customers are calculated as 80% of total customers.
                      </p>
                    </div>
                    <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
                      ...
                      <p className="text-sm text-purple-600">
                        Profit is automatically calculated as 70% of revenue, with expenses at 30%. These ratios can be customized.
                      </p>
                    </div>
                  </div>
                </CardContent>
